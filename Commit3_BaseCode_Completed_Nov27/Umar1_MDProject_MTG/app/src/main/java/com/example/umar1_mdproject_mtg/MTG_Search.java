...
public class MTG_Search extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListViewMTGG.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                //String s = ListViewMTGG.getItemAtPosition(i).toString(); //obtains value of what is written in the entry is tapped
                //Toast.makeText(getBaseContext(), String.valueOf(i), Toast.LENGTH_LONG).show(); //obtains row value

                //Below obtains card id of the card/entry selected in the list view
                //Toast.makeText(getBaseContext(), CardIds.get(i), Toast.LENGTH_LONG).show();
                //ListViewMTG.dismiss(); // If you want to close the adapter
                ...
                intent.putExtra(Intent.EXTRA_TEXT, CardIds.get(i));
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                for (int i = 0; i < CardArray.length(); i++) {
                    ...
                    lstData.add("Card Name: " + String.valueOf(obj.getString("name")));
                    CardIds.add(String.valueOf(obj.getString("id")));
    ...
    //                    currentView.append("\nimg URL: " + String.valueOf(obj.getJSONObject("image_uris").getString("small")) + "\n\n");
                            ...
                            /*tried to do something with images but failed, ignore this code:
